...
const TiltRender = (function () {
  ...
  const MARBLE_INFO = [
    ...
    ['stone',      'Stone',           'basic',  'Dead weightless rubble. Never matches. Only force removes one: a Crusher, a zap, a Bomb or a Sting.'],
    ...
    ['flashdiag',  'Flash Diagonal',  'level',  'Repaints the two diagonals running down from it.'],
    ...
    ['colbomb',    'Colour Bomb',     'level',  'Turns every marble of one colour into armed Bombs. The board becomes a minefield: the next thing to land near one sets it off.'],
    ...
    ['tower',      'Tower',           'arcade', 'Fills one of their columns to the brim with stone. No room left to work, and the first rise of that see-saw overloads it.'],
    ['blocker',    'Blocker',         'arcade', 'Sits there and seals the columns either side. Nothing dropped or thrown can land beside it until it is destroyed.'],
