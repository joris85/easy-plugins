    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul>
                            ...
                            <li data-translate="PRIVACY_EASY_IMAGE_2">Automatic deletion after 6 hours</li>
                            <li data-translate="PRIVACY_EASY_IMAGE_3">Manual cleanup available via <a href="/easy-image/cleanup_images.php" target="_blank" class="text-decoration-none">cleanup manager</a></li>
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong data-translate="PRIVACY_DATA_RETENTION_IMAGES">Images:</strong> Automatically deleted after 6 hours<br>
                ...
                <div class="row">
                    <div class="col-12">
                        <h6><i class="fas fa-tools text-success me-2"></i>Available Tools</h6>
                        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p data-translate="PRIVACY_CONTACT_DESC">For privacy questions or concerns:<br>
                        <a href="mailto:web@jorsites.com" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-envelope me-1"></i>web@jorsites.com
                        </a></p>
                    </div>
                </div>
            </div>
